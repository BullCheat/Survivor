...
public class CustomEntityFirework_1_8_3_R02 extends EntityFireworks {
	Player[] players = null;

	public CustomEntityFirework_1_8_3_R02(World world, Player... p) {
		super(world);
		players = p;
		this.a(0.25F, 0.25F);
	}
	...
	public static void spawn(Location location, FireworkEffect effect, Player... players) {
		try {
			CustomEntityFirework_1_8_3_R02 firework = new CustomEntityFirework_1_8_3_R02(((CraftWorld) location.getWorld()).getHandle(), players);
